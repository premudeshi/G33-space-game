...
from constants import SCREEN_WIDTH, SCREEN_HEIGHT, SCREEN, bullets, all_sprites, enemies, enemy_bullets
from backgrounds import draw_pause_menu, Menu, draw_spread, draw_main_menu, draw_background, draw_hi_scores, draw_log_in, draw_sign_up
    ...
    def run(self, username):
        ...
        while running:
            ...
            # if game is paused, call the pause screen options in backgrounds.py
                ...
                spread, reverse, ram, rev_spread, life, fire, sprites, quit_game = draw_pause_menu(self.screen, self.player.upgrades)
                pygame.display.flip()
